      ...
      <div className="mt-16 max-w-4xl mx-auto px-4">
        <div className="rounded-3xl border border-gray-200 dark:border-gray-800 bg-white/40 dark:bg-gray-900/40 p-8 sm:p-10 flex flex-col md:flex-row items-center justify-between gap-6 text-start">
          ...
          <a
            ...
            className="rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold font-alexandria text-xs sm:text-sm px-6 py-4 shadow-md shadow-emerald-600/20 hover:scale-[1.01] transition-all whitespace-nowrap cursor-pointer"
          >
            {isAr ? "عرض باقات الاشتراك" : "View Pricing Plans"}
          </a>
        </div>
      </div>
